...
def banner():
    os.system("figlet MBomb | toilet -f term -F gay")
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    exit()
        print("\033[92m==================================================================")
        print("\033[93m                BOMBING in progress, please wait !!               ")
        print("     Please keep your data connection active during bombing !!    ")
        print("\033[92m==================================================================")
        print("\033[96m             Target Number           : +" + str(cc) + " ", target)
        print("             Number of Requests Sent : ", requested)
        print("             Successful Requests     : ", success)
        print("             Failed Requests         : ", failed)
        print("\033[92m==================================================================")
        print(" \033[91m             Use this for fun, not for revenge !!                ")
...
while True:
    ...
    if '+' in cc:
        ...
        cc = ''.join(tc)
        cc = cc.strip()
    pn = input("\t\033[95mEnter Target Number: +" + cc + " ")
    pn = remsp(pn)
...
try:
    ...
    type = 0
if type == 1:
    nm = int(input("\n\033[96mEnter Number of Calls To Send(Maximum 15): "))
    if nm > 15:
    ...
    if cc == "91":
        nm = int(input("\nEnter Number of Messages To Send(0 For Unlimited): "))
        dl = float(
            input("\nEnter Delay time (in seconds) [Recommended 2 sec ] : "))
    else:
...
if nm == 0:
    ...
    t = [None] * nt
    print("\n\n\033[93m==================================================================")
    print("   \033[94m             Gearing Up Bomber, please wait !!               ")
    print("     Please keep your data connection active during bombing !!    ")
    print("\033[93m==================================================================")
    print("    \033[95m         Target Number       : +91", pn)
    print("             Number of Threads   : ", nt)
    print("             Delay               : ", dl)
    print("\033[93m==================================================================")
    print("   \033[96m           Use this for fun, not for revenge !!                ")
    print("              This Bomber Was Created By SpeedX !!                ")
    print("\033[93m==================================================================")
